...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <!--- Basic Page Needs  -->
    <meta charset="utf-8">
    <title>JayKay's || App For All The Latest Movies </title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <!-- Mobile Specific Meta  -->
    <meta name="description" content="site for all latest movies">
    
    <meta name="kaywords" content="movies,freemovies,latestmovies,downloadmovies,allmovies,webseries,allwebseries,latestwebseries">
    <!-- CSS -->
...
<body>
    ...
    <h2>JayKay's</h2>
                        <ul>
                            ...
                            <li><span>Latest Movies and WebSeries </span></li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="row" id="dynamicproductpage">
                        <!--<div class="blog-list">-->
    ...
    <script type="text/javascript" language="javascript" src="http://c.amazon-adsystem.com/aax2/assoc.js"></script>
    <SCRIPT charset="utf-8" type="text/javascript" src="//ws-in.amazon-adsystem.com/widgets/q?rt=tf_ssw&ServiceVersion=20070822&MarketPlace=IN&ID=V20070822%2FIN%2Fjaykays-21%2F8003%2Fdcaedb5e-c094-42de-bae0-d5f0d35466de&Operation=GetScriptTemplate"> </SCRIPT> <NOSCRIPT><A rel="nofollow" HREF="//ws-in.amazon-adsystem.com/widgets/q?rt=tf_ssw&ServiceVersion=20070822&MarketPlace=IN&ID=V20070822%2FIN%2Fjaykays-21%2F8003%2Fdcaedb5e-c094-42de-bae0-d5f0d35466de&Operation=NoScript">Amazon.in Widgets</A></NOSCRIPT>
...
result1.forEach(function(element){
    ...
    $("#dynamicproductpage").append('<div class="blog-list">'+
                            '<div class="col-md-6 col-sm-6 col-xs-12">'+
        '<div class="list-item">'+
                                    '<div class="blog-thumbnail">'+
                                        '<a href="#"><img style="height:350px;width:300px;" alt="'+element.name+'" src="../assets/img/'+element.image+'"></a>'+
                                    '</div>'+
