...
<body>
    ...
    <h2>JayKay's</h2>
                        <ul>
                            ...
                            <li><span>Latest Webseries</span></li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="row" id="dynamicproductpage2">
                        <!--<div class="blog-list">-->
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | By <a href="https://instagram.com/kukreja_jazz"><h5>JayKay</h5></a>
</p>
...
result1.forEach(function(element){
    ...
    $("#dynamicproductpage2").append('<div class="blog-list">'+
                            '<div class="col-md-6 col-sm-6 col-xs-12">'+
                            '<div class="list-item">'+
                                    '<div class="blog-thumbnail">'+
                                        '<a href="#"><img style="height:350px;width:300px;" src="../assets/img/'+element.image+'"></a>'+
                                    '</div>'+
